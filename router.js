...
router.post("/delete_user",my_auth,cont_deleteuser);
router.post("/bulk_action",my_auth,cont_bulkaction);
...
router.get("/meeting",my_auth,cont_meeting);
router.post("/create_meeting",my_auth,cont_create_meeting);
router.post("/send_invite",my_auth,cont_send_invite);
router.get("/successmeetingcreate",my_auth,cont_success_meeting_create);
